...
usage <- function() {
  cat(paste(
    ...
    "    [--dr-backend auto|glm|fastglm|speedglm]",
    ...
    "QR solvers: br, fn, pfn, qfnb, pfnb, proqreg, profn, onestep, auto",
    sep = "\n"
  ))
}
...
scalableCounterfactual:::validate_cli_args(args, c(
  ...
  "alpha", "reported_quantiles", "seed", "bootstrap_scheme",
  ...
  "quantile_noncrossing", "cqr_right", "cqr_nsteps",
